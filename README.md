...
1. Bygg domenet og grunnleggende drift.
2. Herd klienter og servere med GPO, kontolasing, rettigheter og logging.
3. Samle hendelser sentralt med WEF/WEC.
4. Eksporter hendelser til JSON med PowerShell.
5. Bygg et lite dashboard i React uten Vite, og eventuelt et tynt Python-API.
6. Kjor to til seks hendelser som elevene ma oppdage, analysere og rette.
...
6. Kjor `Get-SocSummary.ps1` pa collector og la React lese JSON-filen via Python-backend eller lokal fallback-data.
7. Bruk hendelsene i `docs/hendelser-og-vurdering.md` som oppgaver.
8. La elevene levere etikknotat, brukerstotte-sak, behovsanalyse og testlogg i tillegg til teknisk losning.
